...
cl = LINETCR.LINE() 
#cl.login(qr=True)
cl.login(token="EC8dYPrySzl1CyR6UTQ0.ROTYBCAki5rVCFWxQDNfma.fi9dTm2mMDjIekwdyi5y/4a8E24a91XilOsQYVVARVk=")#1
cl.loginResult()


ki = LINETCR.LINE() 
#ki.login(qr=True)
ki.login(token="EC22j5v7BTRYxULSInva.np9Epr5mVXEnJ7kwv/PiMG.y9gKQt8itQYO37XO1bflC9O0/2ZlzKdPPUUYuv6q1sI=")#2
ki.loginResult()


kk = LINETCR.LINE() 
#kk.login(qr=True)
kk.login(token="ECip30dVMH3EK502jHHc.gEFcFBJZKfMb7WPSTdMcpa.c7CV+dJ7IT13khhaEv7dh4Vl2YgT14EkbmlEdpK1td8=")#3
kk.loginResult()


kc = LINETCR.LINE() 
#kc.login(qr=True)
kc.login(token="ECNFOCKP1vUj8c55jtg4.k3IO3WPspYqa8jN66hi21a.cQ3+N0p+xBUjM73iYOOvmY70WcYo23yCYBAGeAF0sYw=")#4
kc.loginResult()


kb = LINETCR.LINE() 
#kb.login(qr=True)
kb.login(token="ECymxggi377g5wUh79r0.IDujR487jt4GMam8GDux4a.WpAi+ACDTSEvo/LuTMIJdMfiTcsZxYfeUggph3Cm2uI=")#5
kb.loginResult()


kd = LINETCR.LINE() 
#kd.login(qr=True)
kd.login(token="ECoywQMzLeItWtLrWX05.uo4DrrgQyCqSHHSjR/sU1q.xQZOFTIYnj8k4IoLzHACAp7AYsOHlsE3QJrtxO+lKJA=")#6
kd.loginResult()


sw = LINETCR.LINE() 
#sw.login(qr=True)
sw.login(token="ECcppm3OVgXGcnlaKttf.chdnAJI6M/OQJqsOU6Nd7W.hWqlI/tvl7qTvw7IZiWcMVev7685dJTOwsQiZsp3m+Q=")#10
sw.loginResult()
print("---LOGIN SUCCES BOSS- SELFBOT SOLO")
poll = LinePoll(cl)
call = cl
creator = ["uae8b726dc68a23946f71fc17a9d9c530"]
owner = ["uae8b726dc68a23946f71fc17a9d9c530"]
admin = ["uae8b726dc68a23946f71fc17a9d9c530"]
staff = ["uae8b726dc68a23946f71fc17a9d9c530"]
...
def help():
    ...
    key = key.title()
    helpMessage = "✰CROWN✰" + key + " [ERIC_BOTS]\n" + \
                  "「✰CROWN✰]  " + key + "✰ERIC BOT✰\n" + \
                  "「✰CROWN✰]  " + key + "Help\n" + \
                  "「✰CROWN✰]  " + key + "Help1\n" + \
                  "「✰CROWN✰]  " + key + "Help2\n" + \
                  ...
                  "「✰CROWN✰]  " + key + "Js\n" + \
                  "「✰CROWN✰]  " + key + "Me\n" + \
                  "「✰CROWN✰]  " + key + "Apakah「Text」\n" + \
                  "「✰CROWN✰]  " + key + "Sadisbot\n" + \
                  "「✰CROWN✰]  " + key + "Clearban\n" + \
                  "「✰CROWN✰]  " + key + "Teroris\n" + \
                  "「✰CROWN✰]  " + key + "Sadiskibar\n" + \
                  "「✰CROWN✰]  " + key + "Jepit\n" + \
                  "「✰CROWN✰]  " + key + "Status\n" + \
                  "「✰CROWN✰]  " + key + "Penyewa\n" + \
                  "「✰CROWN✰]  " + key + "Restart\n" + \
                  "「✰CROWN✰]  " + key + "Bot:on\off\n" + \
                  "「✰CROWN✰]  " + key + "Staff:on\off\n" + \
                  "「✰CROWN✰]  " + key + "Admin on\off\n" + \
                  "「✰CROWN✰]  " + key + "Refresh\n" + \
                  "「✰CROWN✰] " + key + "Kibar\n" + \
                  "「✰CROWN✰]  " + key + "Cek kesehatan\n" + \
                  "「✰CROWN✰]  " + key + "in/joinbot\n" + \
                  "「✰CROWN✰]  " + key + "ut/kluarbot\n" + \
                  "「✰CROWN✰]  " + key + "Sd.Reinvite\n" + \
                  "「✰CROWN✰] 「✭HELP Protect✭」\n" + \
                  "「✰CROWN✰]  " + key + "Antijs stay\n" + \
                  "「✰CROWN✰]  " + key + "Ghost in\n" + \
                  "「✰CROWN✰]  " + key + "Ghost out\n" + \
                  "「✰CROWN✰]  " + key + "!sadis\n" + \
                  "「✰CROWN✰]  " + key + "Sd.reinvite\n" + \
                  ...
                  "「✰CROWN✰]  " + key + "Adminadd @\n" + \
                  "「✰CROWN✰]  " + key + "Admindell @\n" + \
                  "「✰CROWN✰]  " + key + "protectkick on\off\n" + \
                  "「✰CROWN✰]  " + key + "protectjoin on\off\n" + \
                  "「✰CROWN✰]  " + key + "protectinvite on\off\n" + \
                  "「✰CROWN✰]  " + key + "protecturl on\off\n" + \
                  "「✰CROWN✰]  " + key + "Ghost on\off\n" + \
                  "「✰CROWN✰]  " + key + "Bot1,2,3,4up\n" + \
                  "「✰CROWN✰]  " + key + "Semua pro on\off\n" + \
                  "「✰CROWN✰]  " + key + "Antijs on\n" + \
                  "「✰CROWN✰]  " + key + "Runtime\n" + \
                  "「✰CROWN✰]  " + key + "Creator\n" + \
                  "「✰CROWN✰]  " + key + "Speed/Sp\n" + \
                  "「✰CROWN✰]  " + key + "!sadi/kickall\n" + \
                  "「✰CROWN✰]  " + key + "Broadcast:「ᴛᴇxᴛ」\n" + \
                  "「✰CROWN✰]  " + key + "Setkey「New Key」 \n" + \
                  "「✰CROWN✰]  " + key + "Mykey\n" + \
                  "「✰CROWN✰]  " + key + "Resetkey\n" + \
                  "「✰CROWN✰]  " + key + "Refrest\n" + \
                  "「✰CROWN✰]  " + key + "Restart\n"+ \
                  "「✰CROWN✰] [✰ERIC BOTS✰]「✰CROWN✰]"
...
def help1():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = "✰CROWN✰❂͜͡➣ " + key + " [✰ERIC BOTS✰]\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Tagall/Nah\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Ginfo\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Open\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Close\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Url\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Grouplist\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Kibar\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Sdbot\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Harga\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Adminadd @\Admindell @\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Staffadd @\Staffdell @「Nomor」\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Bot:on\off\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Refresh\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Botrefeat @\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Promo\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Infogrup「Nomor」\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Infomem「Nomor」\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Remove chat\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Mid「@」\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Steal「@」\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Cover「@」\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Clone「@」\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Restore\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Backup\n" + \
                   "✰CROWN✰❂͜͡➣" + key + "Reject\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Spamcallto 「Jumlah」 「@」\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Spamtag:「Jumlahnya」\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Spamtag「@」\n" + \
                  "✰CROWN✰❂͜͡➣ " + key + "Spamcall:「Jumlahnya」\n" + \
                   "✰CROWN✰❂͜͡➣ " + key + "Spamcall\n" + \
                   "✰CROWN✰❂͜͡➣ " + key + "Myname:「Nama」\n" + \
                   "✰CROWN✰❂͜͡➣ " + key + "Cpp「Kirim fotonya」\n" + \
                   "✰CROWN✰❂͜͡➣ " + key + "Cvp 「Kirim vidionya」\n" + \
                   "✰CROWN✰❂͜͡➣ " + key + "Updategroup\n" + \
                   "✰CROWN✰❂͜͡➣ " + key + "Gift:「Mid korban」「ᴊᴜᴍʟᴀʜ」\n" + \
                   "✰CROWN✰❂͜͡➣ " + key + "Spam:「Mid korban」「ᴊᴜᴍʟᴀʜ」\n" + \
                   "「✰CROWN✰]   BY:✰CROWN✰] \n" + \
                   "  Creator:  ERIC"
...
def help2():
    ...
    helpMessage2= "      「✭STATUS SET BOTS✭」\n" + \
                  "「✰CROWN✰」 " + key + "Invite 「On/Off」\n" + \
                  "「✰CROWN✰」 " + key + "Sticker「ᴏɴ/Off」\n" + \
                  "「✰CROWN✰」 " + key + "Unsend「ᴏN/Off」\n" + \
                  "「✰CROWN✰」 " + key + "Sider「ᴏɴ/ᴏғғ」\n" + \
                  "「✰CROWN✰」 " + key + "Respon「On/Off」\n" + \
                  "「✰CROWN✰」 " + key + "Timeline「On/Off」\n" + \
                  "「✰CROWN✰」 " + key + "Contact「On/Off」\n" + \
                  "「✰CROWN✰」 " + key + "Autojoin「On/Off」\n" + \
                  "「✰CROWN✰」 " + key + "Autoadd「On/Off」\n" + \
                  "「✰CROWN✰]  " + key + "Welcome「On/Off」\n" + \
                  "「✰CROWN✰]  " + key + "Autoleave「On/Off」\n" + \
                  "「✰CROWN✰] " + key + "Jointicket「On/Off」\n" + \
                  "「✰CROWN✰] " + key + "Cek Sider\n" + \
                  "「✰CROWN✰] " + key + "Cek spam\n" + \
                  "「✰CROWN✰] " + key + "Cek pesan  \n" + \
                  "「✰CROWN✰] " + key + "Cek respon \n" + \
                  "「✰CROWN✰] " + key + "Cek leave\n" + \
                  "「✰CROWN✰] " + key + "Cek welcome\n" + \
                  "「✰CROWN✰] " + key + "Set aider:「Text」\n" + \
                  "「✰CROWN✰] " + key + "Set spam:「Text」」\n" + \
                  "「✰CROWN✰] " + key + "Set pesan:「Text」\n" + \
                  "「✰CROWN✰] " + key + "Set respom:「Text」\n" + \
                  "「✰CROWN✰] " + key + "Set leave:「Text」\n" + \
                  "「✰CROWN✰] " + key + "Set welcome:「Text」\n" + \
                  " [✰CROWN✰ERIC_BOTS\n" + \
                  "Creator:  ERIC "
...
def help3():
    ...
    key = key.title()
    helpMessage3 = "      「✭MUSIK ✭」\n" + \
                  "「✰CROWN✰」 " + key + "Musik「Nama Penyanyi」\n" + \
                  "「✰CROWN✰」 " + key + "Listmp3\n" + \
                  "「✰CROWN✰」 " + key + "Addmp3「Teks」\n" + \
                  "「✰CROWN✰」 " + key + "Dellmp3「Teks」\n" + \
                  "      「✭VIDEO ERIC\n" + \
                  "「✰CROWN✰」 " + key + "Listvideo\n" + \
                  "「✰CROWN✰」 " + key + "Addvideo「Teks」\n" + \
                  "「✰CROWN✰」 " + key + "Dellvideo「Teks」\n" + \
                  "      「✭GAMBAR ERIC\n" + \
                  "「✰CROWN✰」 " + key + "Listimage\n" + \
                  "「✰CROWN✰」 " + key + "Addimg「Teks」\n" + \
                  "「✰CROWN✰」 " + key + "Dellimg「Teks」\n" + \
                  "      「✭STICKER ERIC\n" + \
                  "「✰CROWN✰」 " + key + "Liststicker\n" + \
                  "「✰CROWN✰」 " + key + "Addsticker「Teks」\n" + \
                  "「✰CROWN✰」 " + key + "Dellsticker「Teks」\n" + \
                  "「✰CROWN✰」 " + key + "Kode wilayah\n" + \
                  "      「✭MEDIA LAIN ✭」\n" + \
                  "「✰CROWN✰」 " + key + "Lihat 「Kode wilayah cctv」\n" + \
                  "「✰CROWN✰」 " + key + "Youtube「Query」\n" + \
                  "「✰CROWN✰」 " + key + "Get-fs「Query」\n" + \
                  "「✰CROWN✰」 " + key + "Get-line「ID Line」\n" + \
                  "「✰CROWN✰」 " + key + "Get-apk「Query」\n" + \
                  "「✰CROWN✰」 " + key + "Get-gif「Query」\n" + \
                  "「✰CROWN✰」 " + key + "Get-xxx「Query」\n" + \
                  "「✰CROWN✰」 " + key + "Get-anime「Query」\n" + \
                  "「✰CROWN✰」 " + key + "Get-mimpi「Query」\n" + \
                  "「✰CROWN✰」 " + key + "Get-audio「Query」\n" + \
                  "「✰CROWN✰」 " + key + "Get-mp3「Query」\n" + \
                  "「✰CROWN✰」 " + key + "Get-video「Query」\n" + \
                  "「✰CROWN✰」 " + key + "Get-bintang「Zodiak」\n" + \
                  "「✰CROWN✰」 " + key + "Get-zodiak「Zodiak」\n" + \
                  "「✰CROWN✰」 " + key + "Get-sholat「Nama Kota」\n" + \
                  "「✰CROWN✰」 " + key + "Get-cuaca「Nama Kota」\n" + \
                  "「✰CROWN✰」 " + key + "Get-lokasi「Nama Kota」\n" + \
                  "「✰CROWN✰」 " + key + "Get-lirik「Judul Lagu」\n" + \
                  "「✰CROWN✰」 " + key + "Get-instagram「User Name」\n" + \
                  "「✰CROWN✰」 " + key + "Get-date「tgl-bln-thn」\n" + \
                  "「✰CROWN✰」BY: ✰ERIC BOTS✰\n" + \
                  "  Creator:  ERIC"
            ...
            if mid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        cl.acceptGroupInvitation(op.param1)
                        ginfo = cl.getGroup(op.param1)
                        cl.sendMessage(op.param1,"hii " +str(ginfo.name))
                    else:
                        cl.acceptGroupInvitation(op.param1)
                        ginfo = cl.getGroup(op.param1)
                        cl.sendMessage(op.param1,"hii " + str(ginfo.name))
            if Amid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        ki.acceptGroupInvitation(op.param1)
                        ginfo = ki.getGroup(op.param1)
                        ki.sendMessage(op.param1,"hi " + str(ginfo.name))
            if Bmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        kk.acceptGroupInvitation(op.param1)
                        ginfo = kk.getGroup(op.param1)
                        kk.sendMessage(op.param1,"hi " + str(ginfo.name))
            if Cmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        kc.acceptGroupInvitation(op.param1)
                        ginfo = kc.getGroup(op.param1)
                        kc.sendMessage(op.param1,"hi " + str(ginfo.name))
            if Dmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        kb.acceptGroupInvitation(op.param1)
                        ginfo = kb.getGroup(op.param1)
                        kb.sendMessage(op.param1,"hi " + str(ginfo.name))
            if Emid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        kd.acceptGroupInvitation(op.param1)
                        ginfo = kd.getGroup(op.param1)
                        kd.sendMessage(op.param1,"hi " + str(ginfo.name))
            ...
            try:
                ...
                if op.param3 in Zmid:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        cl.inviteIntoGroup(op.param1,[Zmid])
                        cl.sendMessage(op.param1,"=DONE Bitch=")
                    else:
                        cl.kickoutFromGroup(op.param1,[op.param2])
                        cl.findAndAddContactsByMid(op.param3)
                        cl.inviteIntoGroup(op.param1,[Zmid])
...
#-------------------------------------------------------------------------------                
        ...
        if op.type == 5:
              if wait["autoAdd"] == True:
                  ...
                  sendMention(op.param1, op.param1, "hii ", ", thx")
                  cl.sendText(op.param1, wait["message"])
                  cl.sendContact(op.param1, "uf50d888821632d32461e37153ac775c0")
                    ...
                    if msg_id in msg_dict:
                        if msg_dict[msg_id]["from"]:
                           if msg_dict[msg_id]["text"] == 'Gambarnya dibawah':
                                ...
                                ryan = cl.getContact(msg_dict[msg_id]["from"])
                                ret_ =  "「 ᴘᴇsᴀɴ ᴅɪʜᴀᴘᴜs  」\n"
                                ret_ += "「✰CROWN✰」 ᴘᴇɴɢɪʀɪᴍ : {}".format(str(ryan.displayName))
                                ret_ += "\n「✰CROWN✰」ɴᴀᴍᴀ ɢʀᴜᴘ : {}".format(str(ginfo.name))
                                ret_ += "\n「✰CROWN✰」ᴡᴀᴋᴛᴜ ɴɢɪʀɪᴍ: {}".format(dt_to_str(cTime_to_datetime(msg_dict[msg_id]["createdTime"])))
                                ret_ += "\n• ➣ᴘᴇsᴀɴɴʏᴀ : {}".format(str(msg_dict[msg_id]["text"]))
                                ret_ += "\n 「✰CROWN✰」TEAM :✰ERIC BOTS✰"
                                ret_ += "\nCreator:  Eric" 
                ...
                try:
                    ...
                    if msg_id in msg_dict1:
                        if msg_dict1[msg_id]["from"]:
                                ...
                                ret_ += "「✰CROWN✰」➣ PENGIRIM : {}".format(str(ryan.displayName))
                                ret_ += "\n•「✰CROWN✰」 NAMA GROUP : {}".format(str(ginfo.name))
                                ret_ += "\n•「✰CROWN✰」 WAKTU MENGIRIM : {}".format(dt_to_str(cTime_to_datetime(msg_dict1[msg_id]["createdTime"])))
                                ret_ += "\n⟗「✰CROWN✰」 ✰ERIC BOTS✰"
                                ret_ += "\nCreator:  Eric" 
                       ...
                       if msg._from in admin:
                           ...
                           for x in groups.members:
                               if korban in x.displayName:
                                   client.sendText(send, korban + " done spam")
                               else:
        ...
        if op.type == 25 or op.type == 26:
            ...
            if msg.toType == 2:
               ...
               if msg.contentType == 16:
                    if wait["Timeline"] == True:
                            ...
                            if "text" in msg.contentMetadata:
                                text = "\n• 「✰CROWN✰」Tulisan : {}".format(str(msg.contentMetadata["text"]))
                                purl = "\n• 「✰CROWN✰」Post URL : {}".format(str(msg.contentMetadata["postEndUrl"]).replace("line://","https://line.me/R/"))
                                ret_ += purl
                                ret_ += text
               ...
               if msg.contentType == 7:
                   ...
                   ret_ = "\n\n「 STICKER  INFO」"
                   ret_ += "\n• 「✰CROWN✰」STICKER ID: {}".format(stk_id)
                   ret_ += "\n• 「✰CROWN✰」STICKER VERSI : {}".format(stk_ver)
                   ret_ += "\n• 「✰CROWN✰」STICKER PACKAGE : {}".format(pkg_id)
                   ret_ += "\n• 「✰CROWN✰」STICKER URL: line://shop/detail/{}".format(pkg_id)
                   query = int(stk_id)
                   if type(query) == int:
                ...
                if wait["stickerOn"] == True:
                    ...
                    with requests.session() as s:
                        ...
                        if data == 'Lihat Produk Lain':
                            ...
                            ret_ = "「 STICKER INFO 」"
                            ret_ += "\n• 「✰CROWN✰」PRICE: "+soup.findAll('p', attrs={'class':'mdCMN08Price'})[0].text
                            ret_ += "\n• 「✰CROWN✰」AUTHOR: "+soup.select("a[href*=/stickershop/author]")[0].text
                            ret_ += "\n• 「✰CROWN✰」STICKER ID : {}".format(str(stk_id))
                            ret_ += "\n• 「✰CROWN✰」STICKER PACKAGE : {}".format(str(pkg_id))
                            ret_ += "\n• 「✰CROWN✰」STICKER VERSI : {}".format(str(stk_ver))
                            ret_ += "\n• 「✰CROWN✰」STICKER URL : line://shop/detail/{}".format(str(pkg_id))
               ...
               if msg.contentType == 13:
                 if msg._from in admin:
                  if wait["addbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        cl.sendMessage(msg.to,"done add to bot")
                        wait["addbots"] = True
                    else:
                 ...
                 if wait["dellbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        ...
                        cl.sendMessage(msg.to,"done dell from bot")
                    else:
                        wait["dellbots"] = True
                        cl.sendMessage(msg.to,"done deel from bot ")
#UPDATE FOTO
               if msg.contentType == 1:
                 if msg._from in admin:
                    if wait["Addimage"]["status"] == True:
                        ...
                        cl.sendMessage(msg.to, "done menambahkan gambar {}".format(str(wait["Addimage"]["name"])))
               ...
               if msg.contentType == 2:
                 if msg._from in admin:
                    if wait["Addvideo"]["status"] == True:
                        ...
                        cl.sendMessage(msg.to, "done menambahkan video {}".format(str(wait["Addvideo"]["name"])))
               ...
               if msg.contentType == 7:
                 if msg._from in admin:
                    if wait["Addsticker"]["status"] == True:
                        ...
                        cl.sendMessage(msg.to, "done menambahkan sticker {}".format(str(wait["Addsticker"]["name"])))
               ...
               if msg.contentType == 3:
                 if msg._from in admin:
                    if wait["Addaudio"]["status"] == True:
                        ...
                        cl.sendMessage(msg.to, "done menambahkan mp3 {}".format(str(wait["Addaudio"]["name"])))
               ...
               if msg.toType == 2:
                 if msg._from in admin:
                   if settings["groupPicture"] == True:
                     ...
                     cl.sendMessage(msg.to, "done mengubah foto group")
               if msg.contentType == 1:
                   if msg._from in admin:
                       if mid in Setmain["ARfoto"]:
                            ...
                            cl.sendMessage(msg.to,"Foto done dirubah")
               if msg.contentType == 1:
                 if msg._from in admin:
               ...
               if msg.contentType == 1:
                 if msg._from in admin:
                   if settings["changePicture"] == True:
                     ...
                     ki.sendMessage(msg.to, "done mengubah foto profile bot")
                     kk.updateProfilePicture(path2)
                     kk.sendMessage(msg.to, "done mengubah foto profile bot")
                     kc.updateProfilePicture(path3)
                     kc.sendMessage(msg.to, "done mengubah foto profile bot")
                     kb.updateProfilePicture(path4)
                     kb.sendMessage(msg.to, "done mengubah foto profile bot")
                     ke.updateProfilePicture(path5)
                     ke.sendMessage(msg.to, "done mengubah foto profile bot")
               ...
               if msg.contentType == 1:
                 if msg._from in admin:
                   if settings["changePicture"] == True:
                     ...
                     kd.sendMessage(msg.to, "done mengubah foto profile bot")
                     sw.updateProfilePicture(path3)
                     sw.sendMessage(msg.to, "done mengubah foto profile bot")
               ...
               if msg.contentType == 2:
                   if msg._from in admin:
                       if mid in Setmain["ARvideo"]:
                            ...
                            cl.sendMessage(msg.to,"Foto done dirubah jadi video")
                 ...
                 if text is None:
                     return
                        ...
                        if cmd == "self on":
                            if msg._from in admin:
                                wait["selfbot"] = True
                                cl.sendText(msg.to, "Selfbot is on ")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                md = "\n       「✰CROWN✰STATUS✰CROWN✰」\n"
                                if wait["stickerOn"] == True: md+="「✰CROWN✰」 Sticker「ON」📲\n"
                                else: md+="「✰CROWN✰」 Sticker「OFF」\n"
                                if wait["contact"] == True: md+="「✰CROWN✰」 Contact「ON」📲\n"
                                else: md+="「✰CROWN✰」 Contact「OFF」\n"
                                if wait["talkban"] == True: md+="「✰CROWN✰」 Talkban「ON」📲\n"
                                else: md+="「✰CROWN✰」 Talkban「OFF」\n"
                                if wait["unsend"] == True: md+="「✰CROWN✰」 Unsend「ON」📲\n"
                                else: md+="「✰CROWN✰」 Unsend「OFF」\n"
                                if settings["SpamInvite"] == True: md+="「✰CROWN✰」 Spaminvite「ON」📲\n"
                                else: md+="「✰CROWN✰」 Spaminvite「OFF」\n"
                                if wait["detectMention"] == True: md+="「✰CROWN✰」 Respon「ON」📲\n"
                                else: md+="「✰CROWN✰」 Respon「OFF」\n"
                                if wait["Timeline"] == True: md+="「✰CROWN✰」 Timeline「ON」📲\n"
                                else: md+="「✰CROWN✰」 Timeline「OFF」\n"
                                if wait["autoJoin"] == True: md+="「✰CROWN✰」 Autojoin「ON」📲\n"
                                else: md+="「✰CROWN✰」 Autojoin「OFF」\n"
                                if wait["autoAdd"] == True: md+="「✰CROWN✰」 Autoadd「ON」📲\n"
                                else: md+="「✰CROWN✰」 Autoadd「OFF」\n"
                                if settings["autoJoinTicket"] == True: md+="「✭」 Jointicket「ON」📲\n"
                                else: md+="「✰CROWN✰」 Jointicket「OFF」\n"
                                if msg.to in welcome: md+="「✰CROWN✰」 Welcome「ON」📲\n"
                                else: md+="「✰CROWN✰」 Welcome「OFF」\n"
                                if wait["autoLeave"] == True: md+="「✰CROWN✰」 Autoleave「ON」📲\n"
                                else: md+="「✰CROWN✰」 Autoleave「OFF」\n"
                                if msg.to in protectqr: md+="「✰CROWN✰」Protecturl「ON」📲\n"
                                else: md+="「✰CROWN✰」Protecturl「OFF」\n"
                                if msg.to in protectjoin: md+="「✰CROWN✰」Protectjoin「ON」📲\n"
                                else: md+="「✰CROWN✰」Protectjoin「OFF」\n"
                                if msg.to in protectjoin: md+="「✰CROWN✰」Protectinvite「ON」📲\n"
                                else: md+="「✰CROWN✰」Protecinvite「OFF」\n"
                                if msg.to in protectkick: md+="「✰CROWN✰」Protectkick「ON」📲\n"
                                else: md+="「✰CROWN✰」Protectkick「OFF」\n"
                                if msg.to in protectcancel: md+="「✰CROWN✰」Protectcancel「ON」📲\n"
                                else: md+="「✰CROWN✰」Protectcancel「OFF」\n"
                                if msg.to in protectantijs: md+="「✰CROWN✰」Antijs「ON」📲\n"
                                else: md+="「✰CROWN✰」Antijs「OFF」\n"  
                                if msg.to in ghost: md+="「✰CROWN✰」Ghost「ON」📲\n"
                                else: md+="「✰CROWN✰」Ghost「OFF」\n"
                                ginfo = cl.getGroup(msg.to)
                                ryan = cl.getContact(mid)
                                zx = ""
                                zxc = ""
                                zx2 = []
                                xpesan =  "「 TEAM: ✰ERIC BOTS✰ 」\n• User : "
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            try:
                                ...
                                ret_ = "•「✰CROWN✰」 GROUP : {} GROUP".format(str(len(grouplist)))
                                ret_ += "\n• 「✰CROWN✰」FRIEND : {} FRIEND".format(str(len(contactlist)))
                                ret_ += "\n• 「✰CROWN✰」BLOCKED : {} BLOCKED".format(str(len(blockedlist)))
                                ret_ += "\n• 「✰CROWN✰」FAFORITE : {} FAFORITE".format(str(len(favoritelist)))
                                ret_ += "\n• 「✰CROWN✰」VERSION : 「 SELFBOT  」"
                                ret_ += "\n• 「✰CROWN✰」EXPIRED : {} - {} - {}".format(str(hr), str(bln), str(thn))
                                ret_ += "\n• 「✰CROWN✰」IN DAYS : {} AGAIN".format(days)
                        ...
                        elif cmd == "me" or text.lower() == 'Eric.':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
...
#CLONE
                          ...
                          if 'MENTION' in msg.contentMetadata.keys()!= None:
                                ...
                                for ls in lists:
                                    ...
                                    cl.sendMessage(to, "➧ done clone profile")
...
#                                wait["myProfile"]["coverId"] = str(coverId)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              ...
                              if ginvited != [] and ginvited != None:
                                  ...
                                  cl.sendMessage(to, "done".format(str(len(ginvited))))
                              else:
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                timeCreated.append(time.strftime("%d-%m-%Y [ %H:%M:%S ]", time.localtime(int(G.createdTime) / 1000)))
                                ret_ += "「 Group Info 」"
                                ret_ += "\n「✰CROWN✰」  ɴᴀᴍᴀ ɢʀᴜᴘ : {}".format(G.name)
                                ret_ += "\n「✰CROWN✰」 ID Group : {}".format(G.id)
                                ret_ += "\n「✰CROWN✰」 Pembuat : {}".format(gCreator)
                                ret_ += "\n「✰CROWN✰」 Waktu Dibuat : {}".format(str(timeCreated))
                                ret_ += "\n「✰CROWN✰」 Jumlah Member : {}".format(str(len(G.members)))
                                ret_ += "\n「✰CROWN✰」 Jumlah Pending : {}".format(gPending)
                                ret_ += "\n「✰CROWN✰」 Group Qr : {}".format(gQr)
                                ret_ += "\n「✰CROWN✰」 Group Ticket : {}".format(gTicket)
                                ret_ += "\n「✰CROWN✰」 Picture Url : http://dl.profile.line-cdn.net/{}".format(G.pictureStatus)
                                ret_ += ""
                                cl.sendMessage(to, str(ret_))
                                cl.sendImageWithURL(msg.to, 'http://dl.profile.line-cdn.net/'+G.pictureStatus)
                            except:
...
#                                ret_ += "\n╚══[ Total {} Spam call]".format(str(dan[1]))
                                cl.sendMessage(msg.to, "done Sct ")
                          ...
                          if msg._from in admin:
                            separate = msg.text.split(" ")
                            number = msg.text.replace(separate[0] + " ","pq on")
                            groups = cl.getGroupIdsJoined()
                            ret_ = ""
                            try:
                                group = groups[int(number)-1]
...
#===========BOT UPDATE============#
                        elif msg.text in ["Cipok","Tagall","kids","come1","wow1","tag","ta","Sore","Malam","Nah","All"]:
                               if wait["selfbot"] == True:
                                if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"「 eric bots Admin 」\n\nSuper admin:\n"+ma+"\nAdmin:\n"+mb+"\nStaff:\n"+mc+"\nTotal「%s」" %(str(len(owner)+len(admin)+len(staff))))

                        elif cmd == "!bye":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                cl.sendText(msg.to, "Bye bye baba "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 cl.sendText(msg.to, "「 Status Lurking 」\ndone diaktifkan, selanjutnya ketik lurkers\n\n• Jam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]"+"\n• Tanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d'))
...
#===========Hiburan============#
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                                ...
                                num =  int(strnum)
                                Setmain["RAlimit"] = num
                                cl.sendText(msg.to,"「 Status Spamtag 」\ndone diubah jadi {} kali".format(str(strnum)))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                             if msg.toType == 2:
                                ...
                                cl.sendMessage(msg.to, "done spam call".format(str(wait["limit"])))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              ...
                              cl.sendText(msg.to,"「 Spam Gift 」\ndone spamgift {} kali".format(str(jumlah)))
                              if jumlah <= 1000:
...
#=========== [ Add Image ] ============#
                          ...
                          if msg._from in admin:
                            ...
                            if name in images:
                                ...
                                f = codecs.open("image.json","w","utf-8")
                                json.dump(images, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendText(msg.to, "done ✰ {}".format( str(name.lower())))
                            else:
...
#=========== [ Add Video ] ============#                               
                          ...
                          if msg._from in admin:
                            ...
                            if name in videos:
                                ...
                                f = codecs.open("video.json","w","utf-8")
                                json.dump(videos, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendText(msg.to, "done ✰ video {}".format( str(name.lower())))
                            else:
...
#=========== [ Add Video ] ============#                               
                          ...
                          if msg._from in admin:
                            ...
                            if name in audios:
                                ...
                                f = codecs.open("audio.json","w","utf-8")
                                json.dump(audios, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendText(msg.to, "done ✰ mp3 {}".format( str(name.lower())))
                            else:
...
#=========== [ Add Sticker ] ============#                                            
                          ...
                          if msg._from in admin:
                            ...
                            if name in stickers:
                                ...
                                f = codecs.open("sticker.json","w","utf-8")
                                json.dump(stickers, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendText(msg.to, "done ✰ sticker {}".format( str(name.lower())))
                            else:
                          ...
                          if msg._from in admin:
                            ...
                            for i in group:
                                ...
                                if ginfo == group:
                                    ...
                                    kd.leaveGroup(i)
                                    sw.leaveGroup(i)
                                    cl.sendMessage(msg.to,"done keluar di grup " +str(ginfo.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ...
                                    cl.sendMessage(msg.to,"Grup"+str(ginfo.name)+"done.....")
                                except:
                                    pass
...
">>>BYEE-BYEE<..\nLU DENDAM GUE TUNGGU\n<<<<<<<<<>>\nhttp://line.me/ti/p/~gerhanaselatan\nhttp://line.me/ti/p/~cyber01")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                ki.sendMessage(msg.to, "hi baba   "+str(G.name))
                                kk.acceptGroupInvitationByTicket(msg.to,Ticket)
                                kk.sendMessage(msg.to, "hi baba   "+str(G.name))
                                kc.acceptGroupInvitationByTicket(msg.to,Ticket)
                                kc.sendMessage(msg.to, "hi baba   "+str(G.name))
                                kb.acceptGroupInvitationByTicket(msg.to,Ticket)
                                kb.sendMessage(msg.to, "hi baba   "+str(G.name))
                                kd.acceptGroupInvitationByTicket(msg.to,Ticket)
                                kd.sendMessage(msg.to, "hi baba   "+str(G.name))
                                G = cl.getGroup(msg.to)
                                G.preventedJoinByTicket = True
                                cl.updateGroup(G)
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                ...
                                sw.sendMessage(msg.to, "Ghost in "+str(G.name))
                            ...
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                sw.sendMessage(msg.to, "Ghost out "+str(G.name))
...
#===========KICKOUT============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "[✰ERIC BOTS✰].")
                               elapsed_time = time.time() - start
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                kd.sendMessage(msg.to, "[ done BOSS")
                                cl.sendMessage(msg.to,  "   save \n╚BOSS╗")
                          ...
                          if wait["selfbot"] == True:
                           ...
                           if msg._from in admin:
                              spl = msg.text.replace('Antijs ','Ej ')
                              if spl == 'on':
                           ...
                           if msg._from in admin:
                              spl = msg.text.replace('Allpro ','EAP ')
                              if spl == 'on':
                                  ...
                                  if msg.to in protectcancel:
                                      ginfo = cl.getGroup(msg.to)
                                      msgs = "Eric all protect is on\nDi Group : " +str(ginfo.name)
                                  else:
                                      protectcancel.append(msg.to)
                                      ginfo = cl.getGroup(msg.to)
                                      msgs = "done mengaktifkan semua protect\nDi Group : " +str(ginfo.name)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           admin.append(target)
                                           cl.sendMessage(msg.to,"done add admin")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           staff.append(target)
                                           cl.sendMessage(msg.to,"done add staff")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           Bots.append(target)
                                           cl.sendMessage(msg.to,"done menambahkan bot")
                                       except:
                                           pass

                        elif ("EAdmindell " in msg.text):
                            if msg._from in admin:
                               key = eval(msg.contentMetadata["MENTION"])
                               key["MENTIONEES"][0]["M"]
                               targets = []
                               ...
                               for target in targets:
                                   if target not in Saints:
                                       try:
                                           admin.remove(target)
                                           cl.sendMessage(msg.to,"done dell admin")
                                       except:
                                           pass

                        elif ("EStaffdell " in msg.text):
                            if msg._from in admin:
                               key = eval(msg.contentMetadata["MENTION"])
                               key["MENTIONEES"][0]["M"]
                               targets = []
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                   if target not in Saints:
                                       try:
                                           Bots.remove(target)
                                           cl.sendMessage(msg.to,"done ✰ admin")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           cl.sendMessage(msg.to,"done menambahkan blacklist")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           cl.sendMessage(msg.to,"done ✰ blacklist")
                                       except:
                                           pass
...
#===========COMMAND SET============#
                           ...
                           if msg._from in admin:
                              ...
                              if spl in [""," ","\n",None]:
                                  ...
                                  wait["message"] = spl
                                  cl.sendMessage(msg.to, "「 done Diganti 」\nPesan Msg diganti jadi :\n\n{}".format(str(spl)))
